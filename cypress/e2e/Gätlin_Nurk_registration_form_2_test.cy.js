...
describe('Section 1: Functional tests', () => {
    ...
    it('User can use only same both first and validation passwords', ()=>{
        // In the mentor LIVE session 01.10.24 I asked if we could use the function 
        // inputValidData for all the exercises in assignment 4 and the answer was yes
...
describe('Section 2: Visual tests', () => {
    ...
    it('Check that Cypress logo is correct and has correct size', () => {
        ...
        //width for Cypress logo is 116 and height 88
