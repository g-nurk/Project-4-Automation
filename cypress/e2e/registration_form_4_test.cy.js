...
describe('Input fields', () => {
    ...
    it('Username tooltip is visible', () => {
        ...
        cy.get('h2').contains('Password').click()
        // line 21 .username should be #username
    ...
    it('Email input should support correct pattern', () => {
        ...
        // line 48 #email123 should be written as #email
        cy.get('#email').should('have.attr', 'pattern').should('contain', '[a-z0-9]+@[a-z0-9]+\\.[a-z]{2,4}$')
        cy.get('#email').type('invalid')
        cy.get('h2').contains('Password').click()
        // line 52 should be NOT cy.get('#email').should('have.css', 'image').should('contain', 'rgb(255, 0, 0)') but as shown below
    ...
    it('User cannot submit empty registration form', () => {
        ...
        // line 60 not.be.visible incorrect, be.disabled correct
    ...
    it('BMW should not be listed in the list of the cars', () => {
        ...
        // line 67 should have length, 4 not 5
